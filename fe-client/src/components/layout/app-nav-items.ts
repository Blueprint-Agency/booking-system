import { CalendarDays, GraduationCap, ShoppingBag, Ticket, User, type LucideIcon } from "lucide-react";
...
export const APP_NAV_ITEMS: AppNavItem[] = [
  ...
  { href: "/merch", label: "Merch", icon: ShoppingBag, isActive: (p) => p.startsWith("/merch") },
