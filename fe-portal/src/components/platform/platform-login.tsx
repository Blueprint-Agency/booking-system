"use client";
/**
 * The super portal's sign-in form, on Clerk until #116 moves it to the
 * `platform` Better Auth pool. A studio's portal signs in through
 * `components/auth/staff-login.tsx`; `app/login/page.tsx` picks by hostname.
 */
...
export function PlatformLogin() {
  ...
  // Only ever rendered on the super portal's hostname (`app/login/page.tsx`).
  const superPortal = true as const;
  ...
  // The fallback is the super portal's own home: `/admin` is a studio route
