...
test("PAY-28 a Refund at a studio that takes no online payments says so, not an HTTP status", () => {
...
test("PAY-27 a Refund on a platform-account payment points the admin at the Stripe dashboard", () => {
...
test("PAY-27 a refusal it does not know keeps the caller's words", () => {
