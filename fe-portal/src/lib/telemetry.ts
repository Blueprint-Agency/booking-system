 ...
 * fe-client has its own copy — the apps share no code.
 *
 ...
 * never an email or a name — plus the Tenant id as an attribute (absent on the
...
export function startTelemetry(): void {
  ...
  try {
    ...
    // Telemetry that cannot start must not take the portal down with it.
