...
import { cn, formatDate, formatTime, formatCurrency, spotsText } from "@/lib/utils";
...
export default function SessionDetailPage({
  ...
  const instructor = typedInstructors.find(
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      >
        <Link
          href="/sessions"
          className="inline-flex items-center gap-1.5 text-sm text-muted hover:text-ink transition-colors duration-200 mb-6 group"
        >
          <svg
            width="16"
            height="16"
