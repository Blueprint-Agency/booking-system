        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-extrabold tracking-tight text-lg text-paper">
                Yoga Sadhana
              </span>
            </Link>
            <p className="text-sm leading-relaxed text-paper/70 max-w-[28ch]">
          ...
          {/* Studios */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-paper/50 mb-4">
              Our Studios
            </h4>
